...
class GrantPermissionsCommand (private val adbCommandPrams: AdbCommandPrams) :
        ...
        return when (dependencyResult) {
            is AdbCommandResult.Success -> {
                ...
                if (permissionInfoList.isEmpty())
                    ...
                    grantPermissions(project, device, facet, packageName, permissionInfoList)
            }
    ...
    private fun grantPermissions(
        ...
        permissionInfoList.forEach { permissionInfo ->
            when (val shellReceiverResult =
                device.execute("pm grant $packageName ${permissionInfo.permissionName}", shellReceiver)) {
                ...
                is AdbCommandResult.Success -> {
                    ...
                    if (success.isNotEmpty())
                        project.showNotification(
                            ...
                            "Adb Commander",
                            String.format(
                                "Permissions <b>%s</b> granted on %s",
