...
import com.github.abuballan.adbcommanderplugin.command.StartLauncherActivityCommand
...
class StartAppAction : AdbAction() {
    override fun actionPerformed(event: AnActionEvent, project: Project) {
        runCatching {
            ...
            .onSuccess { selectedAdbCommandParams ->
                StartLauncherActivityCommand(selectedAdbCommandParams).execute {}
            }
            .onFailure { error ->
