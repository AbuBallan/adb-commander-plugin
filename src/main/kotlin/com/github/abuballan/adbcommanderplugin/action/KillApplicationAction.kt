...
import com.github.abuballan.adbcommanderplugin.command.KillApplicationCommand
...
class KillApplicationAction : AdbAction() {
    override fun actionPerformed(event: AnActionEvent, project: Project) {
        runCatching {
            ...
            .onSuccess { selectedAdbCommandParams ->
                KillApplicationCommand(selectedAdbCommandParams).execute {}
            }
            .onFailure { error ->
