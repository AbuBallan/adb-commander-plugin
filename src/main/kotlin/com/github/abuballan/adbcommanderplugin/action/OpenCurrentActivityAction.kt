...
import com.github.abuballan.adbcommanderplugin.command.OpenCurrentActivityCommand
...
class OpenCurrentActivityAction : AdbAction() {
    override fun actionPerformed(event: AnActionEvent, project: Project) {
        runCatching {
            ...
            .onSuccess { selectedAdbCommandParams ->
                OpenCurrentActivityCommand(selectedAdbCommandParams).execute {}
            }
            .onFailure { error ->
